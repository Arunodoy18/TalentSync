  ...
  (
    ...
    const getStaggerDelay = useCallback(
      (index: number) => {
        const total =
          splitBy === "characters"
            ? (elements as WordObject[]).reduce((acc, word) => {
                return acc + word.characters.length + (word.needsSpace ? 1 : 0);
              }, 0)
            : elements.length;
    ...
    return (
      ...
      >
        ...
        {displayWords.map((wordObj, wordIndex, array) => {
              ...
              {wordObj.characters.map((char, charIndex) => (
                ...
                >
                  <motion.span
                    ...
                    variants={variants}
                    onAnimationComplete={
                      wordIndex === displayWords.length - 1 && charIndex === wordObj.characters.length - 1
                        ? onComplete
                        : undefined
                    }
